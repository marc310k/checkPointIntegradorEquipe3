...
import com.dh.cleanodonto.cleanodonto.dto.TokenDTO;
...
public class AutenticacaoController {
    ...
    @PostMapping
    public ResponseEntity autenticar(@RequestBody @Valid LoginDTO loginDTO) throws Exception {
        try{
            UsernamePasswordAuthenticationToken loginUsuario = loginDTO.convert();
